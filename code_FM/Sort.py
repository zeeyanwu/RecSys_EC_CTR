...
from FM_trainer import RecSysDataset,FMTrainer
...
class Predict(object):
    def __init__(self,device='mps'):
        ...
        self.mcf = FMLayer(feature_num, embedding_size, user_fields, item_fields).to(self.device)
        self.loss_fn = nn.BCELoss()
        self.optimizer = torch.optim.Adam(self.mcf.parameters(), lr=0.01)
